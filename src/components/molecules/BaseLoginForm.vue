<template>
  <form novalidate>
    <div class="form-item">
      ...
      <input id="email" v-model="email" type="text" autocomplete="off" placeholder="例：xxxx@domain.com" @focus="resetError" />
    ...
    <div class="form-item">
      ...
      <input id="password" v-model="password" type="password" autocomplete="off" placeholder="例：xxxxxxxx" @focus="resetError" />
      <ul class="validation-errors">
    ...
    <div class="form-actions">
      <BaseButton :disabled="disableLoginAction" @click="handleClick">ログイン</BaseButton>
